...
public class MakeAppointmentTest {
    ...
    public void appointmentShouldBeBooked() {
        ...
        login.loginWithCredentials("John Doe", "ThisIsNotAPassword");

        MakeAppointmentPage appointment = new MakeAppointmentPage(webDriver);
        ...
        SummaryAppointmentPage summary = new SummaryAppointmentPage(webDriver);
